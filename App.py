...
class App():
	...
	def read_csv_file(self, fileName):
	    ...
	    with open(fileName, 'r', newline='', encoding="utf8", errors="ignore") as tsvfile:
	        tsvreader = csv.DictReader(tsvfile, delimiter='\t', fieldnames=['AnnotSV_ID', 'SV_chrom', 'SV_start', 'SV_end', 'SV_length', 'SV_type', 'Scuenca ID'])
	...
	def run(self, fileName1, fileName2, chromosome_id = None, sort = None):
		...
		overlaps = self.find_overlaps_between_chromosomes(sample1, sample2)
